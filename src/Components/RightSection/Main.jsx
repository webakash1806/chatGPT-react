    ...
    return (
        <div className='mb-1 h-full flex flex-col items-center justify-end gap-[12rem]'>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-5 text-[17.5px]'>
                <a className='border border-slate-700 shadow-sm shadow-slate-600 bg-[#313131] w-[17rem] text-center rounded-md p-[12px_20px]' href=''>Try Image Generator!</a>
                <a className=' border border-slate-700 shadow-sm shadow-slate-600 bg-[#313131] w-[17rem] text-center rounded-md p-[12px_20px]' href="">Try with Voice!</a>
            </div>
        </div>
    )
}
