...
const Response = ({ text, isAI }) => {
    return (
        <div className='max-w-[50rem] p-4 mb-6'>
            <p className='pb-1 flex items-center gap-1 text-[17px] font-bold tracking-wide '><FontAwesomeIcon className={`${isAI ? 'bg-[#6366f9]' : 'bg-[#000000]'} w-[11.5px] h-[11.5px] p-[7.5px] rounded-[50%] `}
